  ...
  return (
    <div id="Projects" style={{ margin: "50px" }}>
      ...
      <ProjectComponents
        ...
        img={"public/ProjectTodo.jpg"}
        link={"https://github.com/noor-fatim/TODO-LIST"}
      />
      ...
      <ProjectComponents
        ...
        img={"/public/projectPortfolio.png"}
        link={"https://github.com/noor-fatim/web-page"}
      />
      ...
      <ProjectComponents
        ...
        img={"public/projectContactform.png"}
        link={"https://github.com/noor-fatim/Contactform"}
      />
    </div>
  );
};
